...
public class AdvancePaymentCheckboxValidationInAddExpensePopUp extends BaseClass{

	@Test
	public void AdvancePaymentCheckboxValidationInAddExpensePopUpMethod() throws InterruptedException, IOException{
		...
		Thread.sleep(3000);
		WebElement ExpenseSubCategoryValuePass_EmergencyTravel = driver.findElement(By.xpath("//li[contains(text(),'Advance Payment')]"));
		...
		if(AdvancedPaymentReconciliationCheckbox.isEnabled()) {
