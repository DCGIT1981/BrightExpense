...
public class AddExpense_TravelVouched_ZeroValue extends BaseClass{
	
	
	
	
	@Test
	public  void AddExpenseTravelVouchedZeroValue() throws InterruptedException, IOException {
		...
		Thread.sleep(3000);
		WebElement ExpenseSubCategoryValuePass = driver.findElement(By.xpath("//li[contains(text(),'Travel Vouched')]"));
