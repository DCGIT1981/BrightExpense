...
public class AddExpense_EmergencyTravel_ZeroValue extends BaseClass{
	
	
	@Test

	public void AddExpenseEmergencyTravelZeroValue() throws InterruptedException, IOException {
		...
		Thread.sleep(3000);
		WebElement ExpenseCategoryValuePass = driver.findElement(By.xpath("//li[contains(text(),'Travel')]"));
		...
		Thread.sleep(3000);
		WebElement ExpenseSubCategoryValuePass = driver.findElement(By.xpath("//li[contains(text(),'Emergency Travel')]"));
