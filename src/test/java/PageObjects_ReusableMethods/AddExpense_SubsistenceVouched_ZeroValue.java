...
public class AddExpense_SubsistenceVouched_ZeroValue extends BaseClass{
	
	
	
	@Test
	public  void AddExpenseSubsistenceVouchedZeroValue() throws InterruptedException, IOException {
		...
		Thread.sleep(3000);
		WebElement ExpenseSubCategoryValuePass = driver.findElement(By.xpath("//li[contains(text(),'Subsistence Vouched')]"));
