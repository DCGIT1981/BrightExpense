...
public class AddExpense_EatingOnSite_ZeroValue extends BaseClass{
	
	
	@Test

	public void AddExpenseEatingOnSiteZeroValue() throws InterruptedException, IOException {
		...
		Thread.sleep(3000);
		WebElement ExpenseSubCategoryValuePass = driver.findElement(By.xpath("//li[contains(text(),'Eating On Site')]"));
