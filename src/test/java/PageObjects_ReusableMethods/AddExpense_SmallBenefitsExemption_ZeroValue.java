...
public class AddExpense_SmallBenefitsExemption_ZeroValue extends BaseClass{
	
	
	@Test
	public  void AddExpenseSmallBenefitsExemptionZeroValue() throws InterruptedException, IOException {
		...
		Thread.sleep(3000);
		WebElement ExpenseCategoryValuePass = driver.findElement(By.xpath("//li[contains(text(),'Small Benefits Exemption')]"));
