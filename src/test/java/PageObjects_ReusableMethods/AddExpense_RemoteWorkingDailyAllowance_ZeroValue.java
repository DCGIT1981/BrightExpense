...
public class AddExpense_RemoteWorkingDailyAllowance_ZeroValue extends BaseClass{
	
	
	@Test

	public void AddExpenseRemoteWorkingDailyAllowanceZeroValue() throws InterruptedException, IOException {
		...
		Thread.sleep(3000);
		WebElement ExpenseCategoryValuePass = driver.findElement(By.xpath("//li[contains(text(),'Remote Working Daily Allowance')]"));
