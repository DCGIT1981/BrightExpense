...
public class EmployerSettings extends BaseClass{
	
	
	@Test
	public void EmployerSettings_Method() throws IOException, InterruptedException {
		...
		Thread.sleep(2000);
		WebElement EmployerSettingsTab = driver.findElement(By.xpath("//div[text()='Employer Settings']"));
		Actions actions = new Actions(driver);
		actions.moveToElement(EmployerSettingsTab).perform();
		EmployerSettingsTab.click();
		System.out.println("Successfully clicked on the Employer Settings tab of the Settings page");
	...
	public void ChooseFile() {
		try {
			...
			WebElement ROSCertificateDropdownButton = driver.findElement(By.xpath("//button[@id='dropdownMenuButton']"));
			ROSCertificateDropdownButton.click();
			System.out.println("Successfully clicked on the Certificate dropdown button of the Employer Settings tab");

			WebElement ROSCertificateUpdateButton = driver.findElement(By.xpath("//a[text()='Update']"));
			ROSCertificateUpdateButton.click();
			System.out.println("Successfully clicked on the Certificate Update button of the Employer Settings tab");
			
			
			driver.findElement(By.xpath("//button[@class='btn-upload btn-primary relative float-start']")).click();
			System.out.println("Successfully clicked on the Choose File button of the Employer Settings tab");
	...
	public void P12CertificateUpload() throws InterruptedException, IOException {
		...
		Runtime.getRuntime().exec(
	        System.getProperty("user.dir") + "\\src\\main\\java\\Resources\\DotP12.exe");
		Thread.sleep(2000);
		...
		Thread.sleep(2000);
		WebElement P12CertificateSaveButton = driver.findElement(By.xpath("(//button[text()=' Save '])[1]"));
		Actions actions = new Actions(driver);
