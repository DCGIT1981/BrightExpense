...
public class ExpenseImport extends BaseClass{
	
	
	

	@Test
	public  void ExpenseImportChecking() throws InterruptedException, IOException {
		...
		Thread.sleep(1000);
		WebElement ExpenseImportButton = driver.findElement(By.xpath("//span[contains(text(),'Import')]"));
		actions.moveToElement(ExpenseImportButton).perform();
		ExpenseImportButton.click();
		System.out.println("Successfully clicked on the Expense Import button on the Expenses page");
		
		
		
		
		Thread.sleep(3000);
		WebElement ChooseFileButton = driver.findElement(By.xpath("//span[contains(text(),'Choose File')]"));
		actions.moveToElement(ChooseFileButton).perform();
		...
		Thread.sleep(3000);
		Runtime.getRuntime().exec("C:\\D-DRIVE\\JAVA\\ExpenseImportFile.exe");
		Thread.sleep(2000);
		System.out.println("Successfully selected an Expense file from the folder");
		...
		NextButton.click();
		System.out.println("Successfully clicked on the Next button on the Expenses Import page");
